# ACT Skills for Scout v1.3.0

Curated Scout-native package for user-global Scout discovery through the
OneDrive-backed ACT skill library. It is pending source publication and
...
When published, this 23-skill package is delivered to:
...
`v1.3.0` adds `act-meditation-continuity`, an approval-first Scout-native
