...
`v1.12.0` automatically registers the five validated MCP profiles during every
applied ACT skill installation. Fabric RTI remains conditional on a validated
non-production Kusto allow-list.
